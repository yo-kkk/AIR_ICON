...
public class Step03 extends AbstractController{
	private static final Logger logger = LoggerFactory.getLogger(Step03.class);
	...
	public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
		...
		if(acom_infoDTO.getHost_id()==null) {
			...
			ModelAndView mav = new ModelAndView("/WEB-INF/views/become_host/step03.jsp");
