...
public class Step02 extends AbstractController{
	private static final Logger logger = LoggerFactory.getLogger(Step02.class);
	...
	public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
		...
		if(acom_infoDTO.getHost_id()==null) {
			...
			ModelAndView mav = new ModelAndView("/WEB-INF/views/become_host/step02.jsp");
