...
import profile.models.Review_profileDTO;

public class ProfileList4 extends AbstractController {
	@Override
	public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			totalCount = profileDAO.getTotalCount_user_review((String)session.getAttribute("user_id"));
			...
			java.util.List<Review_profileDTO> reviewList = profileDAO.getReview_user_List(pageDTO, (String)session.getAttribute("user_id"));
			
			
			ModelAndView mav = new ModelAndView();
			mav.setViewName("/WEB-INF/views/profile/ProfileList4.jsp");
