...
public class Step02Update extends AbstractController{
	private static final Logger logger = LoggerFactory.getLogger(Step02Update.class);
	...
	public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
		...
		if(acom_infoUpdateDTO.getHost_id()==null) {
			...
			ModelAndView mav = new ModelAndView("/WEB-INF/views/become_host_update/step02_update.jsp");
