...
public class ProfileList5 extends AbstractController {
	@Override
	public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			totalCount = profileDAO.getTotalCount_host_review((String)session.getAttribute("user_id"));
			...
			java.util.List<Review_profileDTO> reviewList = profileDAO.getReview_host_List(pageDTO, (String)session.getAttribute("user_id"));
			
			
			ModelAndView mav = new ModelAndView();
			mav.setViewName("/WEB-INF/views/profile/ProfileList5.jsp");
