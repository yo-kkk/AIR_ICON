...
import profile.models.Acom_resrv_hostDTO;
import profile.models.ProfileDAO;
import profile.models.ProfileDAOImpl;

public class ProfileList7 extends AbstractController {
	@Override
	public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			totalCount = profileDAO.getTotalCount_host_resrv((String)session.getAttribute("user_id"));
			...
			java.util.List<Acom_resrv_hostDTO> acom_resrv_host = profileDAO.getResrv_host_List(pageDTO, (String)session.getAttribute("user_id"));
			
		
			ModelAndView mav = new ModelAndView();
			mav.setViewName("/WEB-INF/views/profile/ProfileList7.jsp");
			mav.addObject("acom_resrv_host", acom_resrv_host);
