...
public class Step03Update extends AbstractController{
	private static final Logger logger = LoggerFactory.getLogger(Step03Update.class);
	...
	public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
		...
		if(acom_infoUpdateDTO.getHost_id()==null) {
			...
			ModelAndView mav = new ModelAndView("/WEB-INF/views/become_host_update/step03_update.jsp");
