...
<body>
	...
	<!-- main box -->
	<form name="myform" method="post" action="acom_update3_action">
		...
		<div class="ask">
			...
			<div class="checkbox_div">				
				<input type="checkbox" class="check_box" name="kitchen" 
									<c:if test="${acom_infoUpdateDTO.kitchen  eq  'y'}">checked</c:if> >
