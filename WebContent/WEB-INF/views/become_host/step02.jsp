...
<head>
	...
	<title>호스트로 등록하는중입니다 2/3·AirIcon</title>
...
<body>
	...
	<!-- main box -->
	<form name="myform" method="post" action="step02_action">
	...
	<div class="main_box">
		...
		<div class="ask_02">
			...
			<c:if test="${acom_infoDTO.intro_title != null}">value="${acom_infoDTO.intro_title}"</c:if> >
		...
		<div class="ask_03">
			...
			<textarea class="form-control intro_content" rows="17" name="intro_cont" placeholder="숙소 설명"><c:if test="${acom_infoDTO.intro_cont != null}">${acom_infoDTO.intro_cont}</c:if></textarea>
		...
		<div class="ask_04">
			...
			<textarea class="form-control intro_content" rows="8" name="intro_etc" placeholder="참고사항"><c:if test="${acom_infoDTO.intro_etc != null}">${acom_infoDTO.intro_etc}</c:if></textarea>		
		</div>
		
		<div class="ask_05">
			<h4 class="intro_font"><li>숙소와 가까운 대중교통에 대해 설명해주세요</li></h4>
			
			<textarea class="form-control intro_content" rows="4" name="intro_pubtrans" placeholder="대중교통"><c:if test="${acom_infoDTO.intro_pubtrans != null}">${acom_infoDTO.intro_pubtrans}</c:if></textarea>		
		</div>
